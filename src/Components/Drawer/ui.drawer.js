...
export const Drawer = function ({ children, updateOpen }) {
  return (
    <div className="w-full h-full bg-black bg-opacity-5 absolute top-0 left-0 z-[101] overflow-hidden">
      <AnimatePresence>
        <motion.div
          drag="y"
        ...
        >
          ...
          >
            <div
              className={`h-[90%] box-border px-50 w-full bg-black bg-opacity-80 backdrop-blur-lg border-1 border-gray-500 rounded-tl-2xl rounded-tr-2xl shadow-md overflow-hidden -bottom-1 absolute flex flex-col`}
            >
